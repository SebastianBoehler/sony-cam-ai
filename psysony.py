# Source: https://github.com/Bloodevil/sony_camera_api/blob/develop/src/pysony.py
...
class ControlPoint(object):
    ...
    def discover(self, duration=1):
        ...
        for packet in packets:
            ...
            endpoint = self._read_device_definition(resp["location"]).replace(
                "/sony", ""
            )
...
def payload_header(data, payload_type=1):
    ...
    start_code, jpeg_data_size_2, jpeg_data_size_1, jpeg_data_size_0, padding_size = (
        unpack_from("!IBBBB", data)
    )
    ...
    jpeg_data_size = (
        jpeg_data_size_0 * 2**0 + jpeg_data_size_1 * 2**8 + jpeg_data_size_2 * 2**16
    )
...
def payload_header_jpeg(data):
    ...
    payload_header = {"reserved_1": reserved_1, "flag": flag}
    return payload_header
...
class SonyAPI:
    def __init__(
        self, QX_ADDR="http://10.0.0.1:10000", params=None, debug=None, maxversion=None
    ):
    ...
    def _access(self, method=None, param=[]):
        ...
        try:
            result = eval(
                urlopen(
                    self.QX_ADDR + "/sony/accessControl",
                    bytearray(json.dumps(self.params), "utf8"),
                ).read()
            )
    ...
    def _cmd(self, method=None, param=[], target=None, version="1.0", minversion="1.0"):
        ...
        if self.maxversion < minversion:
            raise ValueError(
                "Method %s with 'minversion' %s exceeds user supplied 'maxversion' %s",
                method,
                minversion,
                self.maxversion,
            )
    ...
    def liveview(self, param=None, version="1.0"):
        if param:
            liveview = self._cmd(
                method="startLiveviewWithSize", param=param, version=version
            )
        else:
    ...
    def setShootMode(self, param=None, version="1.0"):
        if not param:
            logger.info(
                """[ERROR] please enter the param like below
    ...
    def setTrackingFocus(self, param=None, version="1.0"):
        return self._cmd(method="setTrackingFocus", param=param, version=version)

    def setContShootingMode(self, param=None, version="1.0"):
        return self._cmd(method="setContShootingMode", param=param, version=version)

    def setContShootingSpeed(self, param=None, version="1.0"):
        return self._cmd(method="setContShootingSpeed", param=param, version=version)

    def setSelfTimer(self, param=None, version="1.0"):
        return self._cmd(method="setSelfTimer", param=param, version=version)

    def setExposureMode(self, param=None, version="1.0"):
        return self._cmd(method="setExposureMode", param=param, version=version)
    ...
    def setExposureCompensation(self, param=None, version="1.0"):
        return self._cmd(method="setExposureCompensation", param=param, version=version)
    ...
    def setShutterSpeed(self, param=None, version="1.0"):
        return self._cmd(method="setShutterSpeed", param=param, version=version)

    def setIsoSpeedRate(self, param=None, version="1.0"):
        return self._cmd(method="setIsoSpeedRate", param=param, version=version)

    def setWhiteBalance(self, param=None, version="1.0"):
        return self._cmd(method="setWhiteBalance", param=param, version=version)

    def setProgramShift(self, param=None, version="1.0"):
        return self._cmd(method="setProgramShift", param=param, version=version)

    def setFlashMode(self, param=None, version="1.0"):
        return self._cmd(method="setFlashMode", param=param, version=version)

    def setAutoPowerOff(self, param=None, version="1.0"):
        return self._cmd(method="setAutoPowerOff", param=param, version=version)
    ...
    def setCurrentTime(self, param=None, version="1.0"):
        return self._cmd(
            method="setCurrentTime", param=param, target="system", version=version
        )
    ...
    def setStillQuality(self, param=None, version="1.0"):
        return self._cmd(method="setStillQuality", param=param, version=version)

    def setPostviewImageSize(self, param=None, version="1.0"):
        return self._cmd(method="setPostviewImageSize", param=param, version=version)

    def setMovieFileFormat(self, param=None, version="1.0"):
        return self._cmd(method="setMovieFileFormat", param=param, version=version)

    def setMovieQuality(self, param=None, version="1.0"):
        return self._cmd(method="setMovieQuality", param=param, version=version)

    def setSteadyMode(self, param=None, version="1.0"):
        return self._cmd(method="setSteadyMode", param=param, version=version)

    def setViewAngle(self, param=None, version="1.0"):
        return self._cmd(method="setViewAngle", param=param, version=version)

    def setSceneSelection(self, param=None, version="1.0"):
        return self._cmd(method="setSceneSelection", param=param, version=version)

    def setColorSetting(self, param=None, version="1.0"):
        return self._cmd(method="setColorSetting", param=param, version=version)

    def setIntervalTime(self, param=None, version="1.0"):
        return self._cmd(method="setIntervalTime", param=param, version=version)
    ...
    def setTvColorSystem(self, param=None, version="1.0"):
        return self._cmd(method="setTvColorSystem", param=param, version=version)
    ...
    def getSupportedWindNoiseReduction(self, version="1.0"):
        return self._cmd(method="getSupportedWindNoiseReduction", version=version)

    def getAvailableWindNoiseReduction(self, version="1.0"):
        return self._cmd(method="getAvailableWindNoiseReduction", version=version)

    def setCameraFunction(self, param=None, version="1.0"):
        return self._cmd(method="setCameraFunction", param=param, version=version)

    def setAudioRecording(self, param=None, version="1.0"):
        return self._cmd(method="setAudioRecording", param=param, version=version)

    def setWindNoiseReduction(self, param=None, version="1.0"):
        return self._cmd(method="setWindNoiseReduction", param=param, version=version)

    def getSourceList(self, param=None, version="1.0"):
        return self._cmd(
            method="getSourceList", param=param, target="avContent", version=version
        )
    ...
    def getSupportedContShootingMode(self, version="1.0"):
        return self._cmd(method="getSupportedContShootingMode", version=version)

    def getAvailableContShootingMode(self, version="1.0"):
        return self._cmd(method="getAvailableContShootingMode", version=version)
    ...
    def getSupportedContShootingSpeed(self, version="1.0"):
        return self._cmd(method="getSupportedContShootingSpeed", version=version)

    def getAvailableContShootingSpeed(self, version="1.0"):
        return self._cmd(method="getAvailableContShootingSpeed", version=version)
    ...
    def getSupportedExposureCompensation(self, version="1.0"):
        return self._cmd(method="getSupportedExposureCompensation", version=version)

    def getAvailableExposureCompensation(self, version="1.0"):
        return self._cmd(method="getAvailableExposureCompensation", version=version)
    ...
    def actWhiteBalanceOnePushCustom(self, version="1.0"):
        return self._cmd(method="actWhiteBalanceOnePushCustom", version=version)
    ...
    def getSupportedPostviewImageSize(self, version="1.0"):
        return self._cmd(method="getSupportedPostviewImageSize", version=version)

    def getAvailablePostviewImageSize(self, version="1.0"):
        return self._cmd(method="getAvailablePostviewImageSize", version=version)
    ...
    def startStreaming(self, version="1.0"):
        return self._cmd(method="startStreaming", target="avContent", version=version)

    def pauseStreaming(self, version="1.0"):
        return self._cmd(method="pauseStreaming", target="avContent", version=version)

    def stopStreaming(self, version="1.0"):
        return self._cmd(method="stopStreaming", target="avContent", version=version)
    ...
    def getSupportedInfraredRemoteControl(self, version="1.0"):
        return self._cmd(method="getSupportedInfraredRemoteControl", version=version)

    def getAvailableInfraredRemoteControl(self, version="1.0"):
        return self._cmd(method="getAvailableInfraredRemoteControl", version=version)
    ...
    def getSchemeList(self, version="1.0"):
        return self._cmd(method="getSchemeList", target="avContent", version=version)
